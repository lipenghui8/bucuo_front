...
<scroll-view @scrolltolower="onScrollToLower" class="scroll-body" enhanced="true" :lowerThreshold="100" :scrollTop="scrollTop" scroll-y="true" showScrollbar="false">
...
export default {
  ...
  onShareAppMessage: function () {
    return {
      ...
      path: "/pagesOther/dynamic/dynamic"
    };
  },
  methods: {
	inputChange(e) {
    ...
    preview: function (e) {
      ...
      uni.navigateTo({
        url: "../../pagesOther/dynamicdetail/dynamicdetail?url=" + encodeURIComponent(t)
      });
    },
