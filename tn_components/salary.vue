		...
		<view class="contaier" style="background-color: #FFFFFF;">
			<view class="top_bg">
				<view class="one_box">
					...
					<view class="top3">
						<view class="num_two">
							<image class="huangguan2" src="http://bucuo.liph.top/static//rank/two.png"></image>
					...
					<view class="top3">
						<view class="num_one">
							<image class="huangguan1" src="http://bucuo.liph.top/static//rank/one.png"></image>
					...
					<view class="top3">
						<view class="num_three">
							<image class="huangguan2" src="http://bucuo.liph.top/static//rank/three.png"></image>
				...
				<view class="number_sy_box">
					...
					<view class="number_sy_main">
						...
						<image mode="widthFix" class="xiaoding_bg" src="http://bucuo.liph.top/static//rank/Intersect.png"></image>
					</view>
				</view>
			</view>
			...
			<view class="rankList_box">
				<view class="rankItem" v-for="(item,index) in rankList" :key="index">
					...
					<view class="download_box">
						<image mode="widthFix" src="http://bucuo.liph.top/static//rank/download.png"></image>
					</view>
				</view>
			</view>
		</view>
