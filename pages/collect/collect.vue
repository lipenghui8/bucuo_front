<template>
	<view>
		<u-navbar :is-back="true" title="我的收藏" title-width="325" title-color="#333333" title-size="28"
			:border-bottom="false"></u-navbar>
		<view class="safe-area-inset-bottom u-skeleton">
			<view class="u-flex u-row-left u-flex-wrap u-p-l-40 u-p-t-30">
				<view class="tab u-skeleton-fillet" @click="detail(item._id)" v-for="(item, index) in coverList"
					:key="index">
					<image
						:src="vuex_compressPicture?item.image+'?x-oss-process=image/resize,w_600/quality,q_80':item.image"
