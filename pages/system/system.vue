<template>
	<view v-if="vuex_user.system">
		...
		<view class="u-flex u-row-left u-col-center u-flex-wrap u-text-center u-p-t-30 u-p-b-30" v-if="vuex_user.system == 2">
			...
			<view class="tab" @click="categoryClick">
				<u-icon name="/static/icon/xiaoxi.png" size="44"></u-icon>
			...
			<view class="tab" @click="designClick">
				<u-icon name="/static/icon/design.png" size="44"></u-icon>
				<view class="u-p-t-10">刘海管理</view>
			</view>
		</view>
		<view class="u-flex u-row-left u-col-center u-flex-wrap u-text-center u-p-t-30 u-p-b-30"  v-if="vuex_user.system == 1">
			<view class="tab" @click="configClick">
				<u-icon name="/static/icon/guanyu.png" size="44"></u-icon>
			...
			<view class="tab" @click="userClick">
				<u-icon name="/static/icon/kefu.png" size="44"></u-icon>
