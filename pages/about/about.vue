<template>
	<view>
		...
		<view class="top u-flex-col u-col-center u-p-t-80">
			...
			<view class="name u-p-t-30 u-font-18">新潮墙纸</view>
			<view class="u-tips-color u-font-14 u-p-t-15">-星芒网络科技-</view>
			<view class="u-tips-color u-font-14 u-p-t-15">V1.0.2</view>
		</view>
