      ...
      <view class="topBox">
        <view class="top-share">
          <view>
            <button
              plain="true"
              style="border: none; height: 80rpx"
              open-type="share"
            >
              <image
                style="width: 50rpx; height: 50rpx; overflow: hidden"
                src="http://bucuo.liph.top/static/me/icon/share.png"
              ></image>
            </button>
          </view>
          <view>
        ...
        <view class="usrBox">
          <view class="sm top-left">
            <!-- <view
              class="cu-avatar2 round xl shadow-blur-lg bg-img open-data"
              style="overflow: hidden"
            >
              <open-data type="chooseAvatar" ></open-data>
            </view> -->
            <button style="overflow: hidden" class="cu-avatar2 round">
              <image
                :src="userData.avatarUrl"
                class="cu-avatar2 round xl shadow-blur-lg bg-img"
          ...
          <view class="sm">
            <view class="top-center">
              <view style="font-weight: 650; font-size: 35rpx"
                >ID:{{ user.id }}</view
              >
              <view>2018商学院</view>
              <view>5级经验用户</view>
          ...
          <view class="xs">
            <view class="top-right">
              <view @click="showCheese">
                <image
                  style="width: 50rpx; height: 50rpx; margin-top: 20rpx"
                  src="http://bucuo.liph.top/static/me/icon/credit.png"
                ></image>
                <view
                  style="
                    margin-top: 23rpx;
              ...
              <view>
                <image
                  style="width: 50rpx; height: 50rpx; margin-top: 80rpx"
                  src="http://bucuo.liph.top/static/me/icon//love.png"
                ></image>
                <view
                  style="
                    margin-bottom: -80rpx;
