		...
		<view class="" v-show="!loadShow">
			...
			<view class="u-p-l-40 u-p-r-40">
				...
				<view class="safe-area-inset-bottom">
					<!--view class="tab u-flex u-row-between u-col-center border-bottom u-p-t-30 u-p-b-30" v-if="chargeShow">
						<view class="u-flex u-row-left u-col-center">
							<view class="icon u-flex u-row-center u-col-center"><u-icon name="/static/icon/user.png" size="46"></u-icon></view>
							<view class="u-p-l-20 u-p-t-10">
								<view class="">充值积分</view>
								<view class="u-font-12 u-light-color">有钱就可以为所欲为</view>
							</view>
						</view>
						<view class="btn" hover-class="hover-class" hover-stay-time="50" @click="charge">去充值</view>
					</view-->
